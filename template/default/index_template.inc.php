...
$menus['csr'] = array('url' => 'index.php?p=csr', 'text' => __('CSR'));
...
<div class="block block-user">
  ...
  <div class="content"><?php echo isset($header_info)? $header_info : APP_WELCOME; ?></div>
</div><!-- end block -->
...
<div class="block block-user">
  ...
  <div class="content">
    ...
    <?php echo __('Lingkungan'); ?> :
    <?php echo $advsearch_topic; ?>
    <?php echo __('Hak Asasi'); ?> :
    <input type="text" name="isbn" />
    <?php echo __('Tenaga Kerja'); ?> :
    <select name="gmd">
    <?php echo $gmd_list; ?>
    </select>
